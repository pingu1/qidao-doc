...
For the purpose of this tutorial, we'll be using Metamask. If you don't have Metamask installed, you can find instructions on [How to get started on Polygon](../investment-tutorials/how-to-get-started-on-polygon.md#downloading-metamask).

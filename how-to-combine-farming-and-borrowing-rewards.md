...
* Leverage amWETH 8 times via AAVE: for this, we will use the exact flow described in the [AAVE token guide](tutoriales-de-inversion/apalancamiento-con-tus-tokens-de-aave.md).

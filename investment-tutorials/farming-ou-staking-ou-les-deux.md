...
Pour ce faire, nous utiliserons les nouvelles réserves de liquidité \(Liquidity Pools\) lancées sur QuickSwap, début de septembre 2021, qui utilisent le jeton Qi de Mai Finance. Si vous ne connaissez pas les applications QuickSwap et Adamant, visitez [Stack DApps like Lego Bricks](https://app.gitbook.com/@qidao-qimps/s/mai-finance-tutorials/v/fr/investment-tutorials/stack-dapps-like-lego-bricks).
...
| Mois | dQUICK | Qi/QUICK | ADDY | Qi/MATIC  Qi/WETH |
| :--- | :--- | :--- | :--- | :--- |
...
Finalement, après un an, un revenu valant $51,580.50 a été généré; avec un investissement initial de $1,000, celà nous donne une APY de 5,087.39%.  
...
Le but n'était pas d'écrire une recette à suivre à l'aveugle alors, s'il vous plait, **faites vos recherches et vos propres simulations**, et n'investisser que ce que vous êtes prêts à perdre.
